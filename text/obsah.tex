...
Citacie: \cite{Testovani_softwaru} \cite{Software_testing} \cite{Software_testing_patton}
...
Pravidla pro psaní zkratek jsou uvedena v~Pravidlech českého pravopisu . I~z~jiných důvodů je vhodné, abyste tuto knihu měli po ruce. 
